    ...
    <div class="container-form register">
        ...
        <div class="form-information">
            <div class="form-information-childs">
                ...
                <form class="form form-register" action="{{ route('iniciarsesion') }}" method="POST" novalidate>
                    <div>
                        <label>
    ...
    <div class="container-form login hide">
        ...
        <div class="form-information">
            <div class="form-information-childs">
                ...
                <form class="form form-login" action="iniciarsesion.php" method="POST" novalidate>
                    <div>
                        <label >
                            <i class='bx bx-envelope' ></i>
